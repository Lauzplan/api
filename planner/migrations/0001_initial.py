# Generated by Django 3.1 on 2021-02-20 17:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, verbose_name="Nom de l'action")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200, unique=True, verbose_name='Nom du jardin')),
                ('postal_code', models.IntegerField(validators=[django.core.validators.MaxValueValidator(9999), django.core.validators.MinValueValidator(1000)], verbose_name='Code postal')),
                ('reference_email', models.EmailField(blank=True, max_length=254, verbose_name='email address')),
                ...
                ('soil_type', models.CharField(blank=True, default='', max_length=100, verbose_name='Type de sol')),
                ('culture_type', models.CharField(blank=True, default='', max_length=100, verbose_name="Type d'agriculture pratiquée sur ce jardin")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dose_used', models.DecimalField(decimal_places=3, max_digits=13, verbose_name='Dose utilisée')),
                ('unity', models.CharField(choices=[('kg', 'kg'), ('g', 'g'), ('l', 'l')], max_length=2, verbose_name='Unité')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='Commentaire éventuel')),
                ('crop_treated', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='planner.cultivatedarea', verbose_name='Culture traitée')),
                ('garden', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='planner.garden')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('commercial_name', models.CharField(max_length=200, verbose_name='Nom commercial du produit')),
                ('quantity', models.DecimalField(decimal_places=3, max_digits=13, verbose_name='Quantité')),
                ('unity', models.CharField(choices=[('kg', 'kg'), ('g', 'g'), ('l', 'l')], max_length=2, verbose_name='Unité')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_cultural_operation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='planner.culturaloperation')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('historyitem_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='planner.historyitem')),
                ('name', models.CharField(max_length=200, verbose_name="Nom de l'opération")),
                ...
                ('original_alert', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='planner.forthcomingoperation')),
            ],
            bases=('planner.historyitem',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_operation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='planner.culturaloperation', verbose_name='Opération précédente')),
            ],
            bases=('planner.culturaloperation',),
        ),
